...
title: "智能体经典范式构建"
module: "hello-agents"
tags: ['AI', 'Agents', 'ReAct', 'Plan-and-Solve', 'Reflection']
---
# 第四章 智能体经典范式构建
...
3. 如果实在不知道如何获取，可以参考 [环境配置](https://github.com/datawhalechina/05-Agent开发/01-Hello-Agents/blob/main/Extra-Chapter/Extra07-环境配置.md)
