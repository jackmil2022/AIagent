...
| 目录 | 内容 |
|---|---|
| [`.`](.) | **案例与实践**（第二版印刷书配套）的 PyTorch 实现。10 章初版完成，**2026 即将出版**。 |
...
| 9  | [图神经网络](chap9图03-深度学习/01-神经网络与深度学习/)          | 初版完成 |
| 10 | [大语言模型与智能体](chap10大语言模型与智能体/) | 初版完成 |

每章产出：可运行 notebook + README（实现要点）+ pytest sanity 测试。环境依赖见 [`requirements.txt`](requirements.txt)。
