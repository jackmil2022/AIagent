...
-   **迭代型 (Iterable-style) 数据集**
    ...
    > **注意：**如果在 `DataLoader` 中开启多进程（num\_workers &gt; 0），那么在加载迭代型数据集时必须进行专门的设置，否则会重复访问样本。例如：
    >
    > <div class="language-python highlighter-rouge">
    >
    > <div class="highlight">
...
本章核心代码存储于：[How-to-use-Transformers/train\_model\_FashionMNIST.py](https://github.com/jsksxs360/How-to-use-Transformers/blob/main/train_model_FashionMNIST.py)
